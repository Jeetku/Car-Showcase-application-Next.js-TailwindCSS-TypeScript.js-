  ...
  return (
    <div className="hero">
      <div className="flex-1 pt-36 padding-x">
        ...
        <p className="hero__subtitle">Streamline your car rentle experience with our effortless experience</p>
      ...
      <div className="hero__image-container">
        <div className="hero__image">
          <Image  src="/hero.png" fill className="object-contain" alt="hero_image"/>
        </div>
